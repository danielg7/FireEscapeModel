...
# COAP Model ----
COAP_TreeHeight_agg <- aggregate(data=COAP_TreeHeight,Height ~ Diameter + Tree..,mean)
...
coap_height+
  ...
  geom_point()
# TESE Model ----
TESE_TreeHeight_agg <- aggregate(data=TESE_TreeHeight,Height ~ Diameter + Tree..,mean)
...
#   geom_point()
# COMO Models ----
COMO_TreeHeight_agg <- aggregate(data=COMO_TreeHeight,Height ~ Diameter + Tree..,mean)
...
como_grid$Height <- exp(predict(COMO_ll,como_grid))
# COMO Plot ----
